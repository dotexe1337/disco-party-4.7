...
package club.michaelshipley.client.option;
...
public final class OptionManager
{
    ...
    public static CopyOnWriteArrayList<Option> optionList;
    ...
    public static Option getOptionsForModule(Class module) {
        for (final Option option : OptionManager.optionList) {
            if ((option.getModule().equals(module))) {
                return option;
            }
        }
        return null;
