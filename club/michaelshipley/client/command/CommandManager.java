...
package club.michaelshipley.client.command;
...
import club.michaelshipley.client.command.commands.OptionCommand;
import club.michaelshipley.client.command.commands.UnknownCommand;
...
public class CommandManager
{
    ...
    public static void start() {
        try {
            final Reflections reflections = new Reflections("club.michaelshipley.client.command.commands", new Scanner[0]);
