...
import club.michaelshipley.client.module.modules.fight.regen.modes.Guardian;
...
{
    @Option.Op(min = 0.0, max = 500.0, increment = 10.0)
    public double packets;
    @Option.Op(name = "Potion Packets", min = 0.0, max = 500.0, increment = 10.0)
    public double potionPackets;
    ...
    public Regen() {
        this.packets = 20.0;
        this.potionPackets = 20.0;
        this.health = 8.0;
        this.old = new Old("Old", true, this);
        this.guardian = new Guardian("Guardian", false, this);
    }
    
    @Override
    public void preInitialize() {
        OptionManager.getOptionList().add(this.old);
