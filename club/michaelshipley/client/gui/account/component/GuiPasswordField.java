    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (var4.length() > 0 && var5 && var2 < var4.length()) {
                var9 = this.fontRendererInstance.func_175063_a(var4.substring(var2).replaceAll("(?s)", "*"), (float) var9, (float) var8, var1);
            }
            ...
            if (var3 != var2) {
                int var12 = var7 + this.fontRendererInstance.getStringWidth(var4.substring(0, var3).replaceAll("(?s).", "*"));
