...
import club.michaelshipley.client.friend.Friend;
import club.michaelshipley.client.friend.FriendManager;
import club.michaelshipley.client.module.ModuleManager;
import club.michaelshipley.client.module.modules.fight.FastBow;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer()
    {
      ...
      this.onGround = eventPre.isOnground();
    ...
    public void sendChatMessage(String s)
    {
    	for(Friend f: FriendManager.friendsList) {
    		if(s.contains("-" + f.alias)) {
    			String s2 = s.replace("-" + f.alias, f.alias);
    			this.sendQueue.addToSendQueue(new C01PacketChatMessage(s2));
    			return;
    		}
    	}
    ...
    {
        if(!ModuleManager.getModule(FastBow.class).isEnabled()) {
        	super.swingItem();
