...
public abstract class EntityPlayer extends EntityLivingBase
{
	...
	public static ResourceLocation ofLocationCape = null;
        ...
        if (targetEntity.canAttackWithItem())
        {
            if (!targetEntity.hitByEntity(this))
            {
                ...
                if (var2 > 0.0F || var4 > 0.0F)
                {
                    ...
                    NoSlowdown noSlowdown = (NoSlowdown) ModuleManager.getModule("NoSlowdown");	
                    
                    if (var14 && !noSlowdown.isEnabled() && noSlowdown != null)
                    {
                        if (var18 > 0)
                        {
